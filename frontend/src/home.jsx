...
function Home() {
  ...
  const navLinkClass = (id, options = {}) => {
    ...
    return `rounded-xl px-3.5 py-2 text-sm font-semibold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500/80 focus-visible:ring-offset-2 ${
      active
  ...
  return (
    <div className="home-page relative min-h-screen overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="relative z-10">
        <header className="home-nav fixed top-0 left-0 right-0 z-50 border-b border-slate-200/70 bg-white/85 backdrop-blur-xl">
          <div className="mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
            <button
              type="button"
              onClick={scrollToTop}
              className="flex min-h-10 min-w-0 items-center gap-3 rounded-2xl px-3 py-1.5 text-left transition duration-200 hover:bg-slate-100/85 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
            >
            ...
            <button
              type="button"
              className="inline-flex min-h-10 min-w-10 items-center justify-center rounded-xl border border-transparent text-slate-600 transition hover:border-slate-200 hover:bg-slate-100 hover:text-slate-900 md:hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
        ...
        <main className="pt-16">
          ...
          <section id="login" className="home-login-section scroll-mt-24 border-y border-slate-200/60 py-16 sm:py-20">
            <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-8 px-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
              ...
              <div className="home-surface mx-auto w-full max-w-md rounded-3xl border border-slate-200/70 bg-white p-6 sm:p-8 flex flex-col justify-center">
            ...
            <section id="about" className="scroll-mt-24 border-t border-slate-200/50 bg-slate-50/65 py-16 sm:py-20">
              <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                  ...
                  <div className="home-surface rounded-3xl border border-slate-200/70 bg-white p-8 lg:col-span-5 flex flex-col justify-between">
                    <div>
